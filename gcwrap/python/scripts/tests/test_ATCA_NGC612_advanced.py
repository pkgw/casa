...
class Test010_NGC612_ADVANCED(unittest.TestCase):
    ...
    def test_00_runGuide(self):
        ...
        exec(compile(open('CASAGuidesATCAAdvancedContinuumPolarizationTutorialNGC612-CASA'+ version +'.py').read(), 'CASAGuidesATCAAdvancedContinuumPolarizationTutorialNGC612-CASA'+ version +'.py', 'exec'))
