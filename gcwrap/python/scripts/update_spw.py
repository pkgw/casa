...
def spwchan_to_sets(vis, spw):
    ...
    try:
        ...
        for scr in scharr:
            ...
            scr[2] += 1
            sets[scr[0]].update(list(range(*scr[1:])))
    except:
        ...
        for s in spwd:
            if s in allrec['spw']:
                ...
                if spwd[s] == '':
                    ...
                    spwd[s] = list(range(mytb.getcell('NUM_CHAN', s)))
                    mytb.close()
