...
#ifndef IMAGEANALYSIS_IMAGESTATSCONFIGURATOR_TCC
#define IMAGEANALYSIS_IMAGESTATSCONFIGURATOR_TCC

#include <imageanalysis/ImageAnalysis/ImageStatsConfigurator.h>

namespace casa {

template <class T> ImageStatsConfigurator<T>::ImageStatsConfigurator(
...
template <class T> void ImageStatsConfigurator<T>::configureBiweight(Int maxIter) {
    if (
...
template <class T> void ImageStatsConfigurator<T>::configureChauvenet(
...
template <class T> void ImageStatsConfigurator<T>::configureClassical(
...
template <class T> void ImageStatsConfigurator<T>::configureFitToHalf(
...
template <class T>
void ImageStatsConfigurator<T>::configureHingesFences(casacore::Double f) {
    if (
...
template <class T> String ImageStatsConfigurator<T>::_configureAlgorithm() {
    String myAlg;
