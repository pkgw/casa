...
// </motivation>
	...
	private:
		typedef std::list<std::shared_ptr<viewer::Rectangle> > rectanglelist;
		...
		std::shared_ptr<viewer::Rectangle> resizing_region;
		std::shared_ptr<viewer::Rectangle> creating_region;
