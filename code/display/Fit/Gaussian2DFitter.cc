...
namespace casa {
	...
	void Gaussian2DFitter::setFitParameters( std::shared_ptr<const ImageInterface<Float> > image, const String& box,
	...
	QList<RegionShape*> Gaussian2DFitter::toDrawingDisplay(const std::shared_ptr<const ImageInterface<Float> > image, const QString& colorName) const {
